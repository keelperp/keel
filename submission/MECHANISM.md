...
skip is that file, not a failure. The full run used for this submission is 52 forge tests + 33
live-state assertions + 8 vault-UI checks = **93, all green**.
...
Those addresses are in [`FACTORY.md`](FACTORY.md) and `deployments/56.json`; the factory to register is `0x2559DD277E5a8E2f6d8594Deded3eD1025e6402C`.
